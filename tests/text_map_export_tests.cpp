...
TEST_CASE("export_text_map rewrites only top-level object fields", "[txt][export]")
{
    const auto left = parse_fixture(
        "left-header\n"
        "square_elev: 0\n\n"
...
TEST_CASE("export_text_map handles blank lines before top-level object fields", "[txt][export]")
{
    const auto left = parse_fixture(
        "left-header\n"
        "square_elev: 0\n\n"
...
TEST_CASE("export_text_map handles blank lines before script fields", "[txt][export]")
{
    const auto left = parse_fixture(
        "left-header\n"
        "square_elev: 0\n\n"
